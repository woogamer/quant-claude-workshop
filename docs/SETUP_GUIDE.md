...
### 2. KIS 모의투자 계좌 + 해외주식 신청 (30분)

한국투자증권 모의투자는 **국내주식**과 **해외주식**이 따로 신청해야 합니다.
워크샵은 저녁이라 한국장이 닫혀있으니 **해외주식 모의투자 필수**.

a. [한국투자증권 API 포털](https://apiportal.koreainvestment.com/) 회원가입
b. 상단 **"모의투자"** → **"국내주식 모의투자"** 신청 (보유고 자동 부여)
c. 같은 페이지에서 **"해외주식 모의투자"** 도 신청 (USD 보유고 자동 부여)
d. 메뉴 **"앱키 발급"** → 모의투자용 App Key / App Secret 발급
e. 계좌번호 확인 (8자리-2자리, 예: `50012345-01`)
